...
avr-gcc -Wall -c drv/hw_wdt.c 				-o out/hw_wdt.o 				-mmcu=atmega64a -D F_CPU=7372800UL -O2
...
avr-gcc -mmcu=atmega64a -o out/main.elf out/main.o out/hw_uart.o out/hw_ext_mem.o out/hw_rom_switching.o out/hw_leds.o out/hw_tmr.o out/hw_wdt.o out/serial_transmission.o
